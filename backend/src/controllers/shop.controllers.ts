...
export const createEditShop=async(req:Request,res:Response)=>{
    try {
        ...
        if (shop) await shop.populate("owner items");
...
export const getShopByCity=async (req:Request,res:Response)=>{
  try {
